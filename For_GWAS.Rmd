...
allele_estimate <- read.csv("~/Desktop/GWAS_manuscript/BMC_genetics/GWAS_permutation/GAPIT..FI.Allelic_Effect_Estimates.csv", header = T)
...
myG=read.table("~/Desktop/GWAS_manuscript/GWAS/GWAS_analysis/data/association/GAPIT/myGAPIT/246_7220_chr14_sorted.hmp.txt", head=T)
myG[1:10, 1:10]
...
site_summary <- read.delim("~/Desktop/GWAS_manuscript/GWAS/GWAS_analysis/data/association/GAPIT/myGAPIT/site_summary_arboreum.txt", header = T)
head(site_summary)
